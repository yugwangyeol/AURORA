#!/bin/bash
# =============================================================================
# PGOT v8.3 evaluation.
# Threshold is primary for BCE; spatial_trainmatch is available for diagnosing
# the outside-log branch with the exact training normalization.
# =============================================================================
set -euo pipefail

MODEL_PATH="${MODEL_PATH:-/home/jovyan/PGOT/checkpoints/pgot_main_v8_3_bce1_outlog1}"
VAL_JSONL="${VAL_JSONL:-/home/jovyan/PGOT/data/pgot_val.jsonl}"
OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/PGOT/outputs/eval_pgot_v8_3_$(basename "${MODEL_PATH}")}"
