...
# =============================================================================
# PGOT v13 smoke test.
# Verifies train, in-training eval, save, offline W&B logging, then standalone
# threshold/mean eval for the V3-style sigmoid outside + register suppression run.
# =============================================================================
set -euo pipefail
...
OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/PGOT/checkpoints/pgot_smoke_v13_sigmoid_out_reg}"
EVAL_OUTPUT_DIR="${EVAL_OUTPUT_DIR:-/home/jovyan/PGOT/outputs/smoke_pgot_v13_eval}"
DIFFUSION_NORM_STATS_PATH="/home/jovyan/data/siglip2_bn_stats.pt"

mkdir -p "${OUTPUT_DIR}" "${EVAL_OUTPUT_DIR}/threshold"
...
export WANDB_NAME="${WANDB_NAME:-pgot_smoke_v13_sigmoid_out_reg}"
...
echo "===== PGOT v13 SMOKE TEST (BS=${PER_DEVICE_TRAIN_BATCH_SIZE}, steps=${MAX_STEPS}) ====="
...
echo "===== PGOT v13 SMOKE EVAL (threshold/mean/coco_instance) ====="
