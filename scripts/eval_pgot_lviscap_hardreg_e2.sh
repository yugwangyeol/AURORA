...
MODEL_PATH="${MODEL_PATH:-/home/jovyan/PGOT/checkpoints/pgot_lviscap_hardreg_e2/checkpoint-10000}"
VAL_JSONL="${VAL_JSONL:-/home/jovyan/PGOT/data/pgot_coco_instance_val.jsonl}"
OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/PGOT/outputs/eval_pgot_lviscap_hardreg_e2_10k_coda512}"
