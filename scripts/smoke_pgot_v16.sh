#!/bin/bash
# Verifies v16 train, in-training eval, save, W&B sigmoid/recon overlays,
...
OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/PGOT/checkpoints/pgot_smoke_v16_void${PGOT_N_NULL_BG}}"
EVAL_OUTPUT_DIR="${EVAL_OUTPUT_DIR:-/home/jovyan/PGOT/outputs/smoke_pgot_v16_void${PGOT_N_NULL_BG}_eval}"
...
export WANDB_NAME="${WANDB_NAME:-pgot_smoke_v16_void${PGOT_N_NULL_BG}}"
export WANDB_DIR="${OUTPUT_DIR}/wandb"
export PYTHONNOUSERSITE=1
export CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-0}"

echo "===== PGOT v16 BCE-BOTTLENECK VOID${PGOT_N_NULL_BG} SMOKE ====="
...
grep -q "\"pgot_n_null_bg\": ${PGOT_N_NULL_BG}" "${OUTPUT_DIR}/config.json"
...
echo "===== PGOT v16 STANDALONE THRESHOLD EVAL ====="
