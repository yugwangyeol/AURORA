#!/usr/bin/env bash
# Teacher-forced CODA-aligned evaluation for E2-Pix-FVW.
set -euo pipefail

MODEL_PATH="${MODEL_PATH:-/home/jovyan/PGOT/checkpoints/pgot_e2_pix_fvw/checkpoint-10000}"
VAL_JSONL="${VAL_JSONL:-/home/jovyan/PGOT/data/pgot_pix2cap_generated_val5k.jsonl}"
OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/PGOT/outputs/eval_pgot_e2_pix_fvw_10k_r2_tf_coda512}"
...
"${PYTHON}" -m pgot.eval.run_eval \
    ...
    --llm_attention_readout "${LLM_ATTENTION_READOUT:-auto}" \
