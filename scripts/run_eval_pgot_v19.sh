#!/bin/bash
# PGOT v19 evaluation: V15-style sigmoid threshold readout on 32x32 masks.
set -euo pipefail

MODEL_PATH="${MODEL_PATH:-/home/jovyan/PGOT/checkpoints/pgot_main_v19_stronger_router}"
VAL_JSONL="${VAL_JSONL:-/home/jovyan/PGOT/data/pgot_val.jsonl}"
OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/PGOT/outputs/eval_pgot_v19_$(basename "${MODEL_PATH}")}"
...
echo "===== PGOT v19 Stronger-Router Eval ====="
