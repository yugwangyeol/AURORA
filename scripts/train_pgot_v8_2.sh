#!/bin/bash
# =============================================================================
# PGOT v8.2 — professor-style outside log penalty.
#
# Loss = LM + recon + spatial outside log.
# For each OVT, patch scores are spatial-softmaxed. Patches inside the target GT
# mask are ignored, and patches outside the target GT mask get sum -log(1 - A).
# =============================================================================
set -e
...
OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/PGOT/checkpoints/pgot_main_v8_2_spatial_outside_log}"
...
export WANDB_NAME="${WANDB_NAME:-pgot_main_v8_2_spatial_outside_log}"
...
echo "===== PGOT v8.2 spatial outside log — B200 x ${NUM_GPUS} ====="
...
echo "Other mask losses:      CE/BCE/Tversky/final-spatial-mass/LLM-QK outside all off"
echo "Eval readout to use:    READOUT=spatial EVAL_MERGE=mean"
