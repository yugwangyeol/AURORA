#!/bin/bash
# =============================================================================
# CaptionSlot Stage 1 wrapper: first-slot + one-register + no prior + recon-only
# =============================================================================
...
export OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/AURORA/checkpoints/captionslot_firstslot_noprior_recon_stage1}"
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-captionslot_firstslot_noprior_recon_stage1}"
...
echo "===== CaptionSlot Stage 1: First-Slot No-Prior Recon-Only ====="
...
echo "CMD length:        ${CAPTIONSLOT_CMD_LENGTH}"
echo "Prior bias scale:  ${CAPTIONSLOT_PRIOR_BIAS_SCALE}"
echo "Caption loss wt:   ${CAPTIONSLOT_CAPTION_LOSS_WEIGHT}"
echo "Div loss wt:       ${CAPTIONSLOT_DIVERSITY_LOSS_WEIGHT}"
echo "Control mode:      ${CAPTIONSLOT_CONTROL_MODE}"
