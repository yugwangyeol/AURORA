...
# =============================================================================
# PGOT v9 smoke test.
# Verifies train, in-training eval loss logging, save, offline wandb, and eval.
# =============================================================================
set -euo pipefail
...
OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/PGOT/checkpoints/pgot_smoke_v9}"
EVAL_OUTPUT_DIR="${EVAL_OUTPUT_DIR:-/home/jovyan/PGOT/outputs/smoke_pgot_v9_eval}"
...
export WANDB_NAME="${WANDB_NAME:-pgot_smoke_v9_bce_spatial_out03}"
...
echo "===== PGOT v9 SMOKE TEST (BS=${PER_DEVICE_TRAIN_BATCH_SIZE}, steps=${MAX_STEPS}) ====="
...
"${PYTHON}" "${PROJECT_ROOT}/train.py" \
    ...
    --pgot_mask_spatial_outside_weight 0.3 \
    --pgot_mask_spatial_temperature 1.0 \
...
echo "===== PGOT v9 SMOKE EVAL (threshold/coco_instance) ====="
