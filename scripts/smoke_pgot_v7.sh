#!/bin/bash
# =============================================================================
# PGOT V7 smoke test: null-bg loss, in-training eval, and offline wandb logging.
# Output is intentionally disposable.
# =============================================================================
set -e
...
OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/PGOT/checkpoints/pgot_smoke_v7_nullbg}"
...
export PGOT_SKIP_FINAL_SAVE=1

PER_DEVICE_TRAIN_BATCH_SIZE="${PER_DEVICE_TRAIN_BATCH_SIZE:-1}"
MAX_STEPS="${MAX_STEPS:-2}"

echo "===== PGOT V7 null-bg SMOKE (BS=${PER_DEVICE_TRAIN_BATCH_SIZE}, steps=${MAX_STEPS}) ====="
...
"${PYTHON}" "${PROJECT_ROOT}/train.py" \
    ...
    --pgot_n_register 64 --pgot_n_null_bg 1 --pgot_n_ovt_per_object 2 --pgot_max_objects 50 \
    --pgot_lm_loss_weight 1.0 \
    --pgot_use_null_bg_competition True \
    --pgot_mask_ce_weight 1.0 \
    --pgot_mask_fg_weight 0.5 \
    --pgot_mask_outside_weight 0.2 \
