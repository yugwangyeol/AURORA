...
# =============================================================================
# PGOT v8 smoke test.
# Verifies train, in-training eval, save, offline wandb logging, and spatial eval.
# =============================================================================
set -euo pipefail
...
OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/PGOT/checkpoints/pgot_smoke_v8}"
EVAL_OUTPUT_DIR="${EVAL_OUTPUT_DIR:-/home/jovyan/PGOT/outputs/smoke_pgot_v8_eval}"
...
export WANDB_NAME="${WANDB_NAME:-pgot_smoke_v8_spatial_outside}"
...
echo "===== PGOT v8 SMOKE TEST (BS=${PER_DEVICE_TRAIN_BATCH_SIZE}, steps=${MAX_STEPS}) ====="
...
"${PYTHON}" "${PROJECT_ROOT}/train.py" \
    ...
    --pgot_mask_spatial_outside_weight 1.0 \
...
echo "===== PGOT v8 SMOKE EVAL (spatial readout) ====="
