#!/bin/bash
# PGOT v18 evaluation: V15-style sigmoid threshold readout plus optional
# diffusion/direct-latent reconstruction rFID.
set -euo pipefail

MODEL_PATH="${MODEL_PATH:-/home/jovyan/PGOT/checkpoints/pgot_main_v18_v15_latent_distill}"
VAL_JSONL="${VAL_JSONL:-/home/jovyan/PGOT/data/pgot_val.jsonl}"
OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/PGOT/outputs/eval_pgot_v18_$(basename "${MODEL_PATH}")_${RECON_SOURCE:-diffusion}}"
...
RECON_SOURCE="${RECON_SOURCE:-diffusion}"
DTYPE="${DTYPE:-fp32}"
...
echo "===== PGOT v18 Latent-Distill Eval ====="
...
echo "Recon source:  ${RECON_SOURCE}"
echo "Guidance/step: ${GUIDANCE_SCALE} / ${DIFF_INFER_STEPS}"
echo "========================================"
