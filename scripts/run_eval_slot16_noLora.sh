...
MODEL_PATH="${MODEL_PATH:-/home/jovyan/AURORA/checkpoints/aurora_refcoco_singlephase_slot16_noLora_stage1_fp32/best-checkpoint}"
OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/AURORA/outputs/slot16_noLora_best_eval}"
