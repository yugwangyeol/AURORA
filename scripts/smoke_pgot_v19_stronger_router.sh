#!/bin/bash
# Verifies v19 train, in-training eval, save, W&B sigmoid/recon overlays,
...
OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/PGOT/checkpoints/pgot_smoke_v19_stronger_router}"
EVAL_OUTPUT_DIR="${EVAL_OUTPUT_DIR:-/home/jovyan/PGOT/outputs/smoke_pgot_v19_stronger_router_eval}"
...
export WANDB_NAME="${WANDB_NAME:-pgot_smoke_v19_stronger_router}"
export WANDB_DIR="${OUTPUT_DIR}/wandb"
export PYTHONNOUSERSITE=1
export CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-0}"

echo "===== PGOT v19 STRONGER-ROUTER SMOKE ====="
...
grep -q '"pgot_v14_router_depth": 3' "${OUTPUT_DIR}/config.json"
grep -q '"pgot_v14_router_mlp_ratio": 4' "${OUTPUT_DIR}/config.json"
...
echo "===== PGOT v19 STANDALONE THRESHOLD EVAL ====="
