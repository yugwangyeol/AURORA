#!/bin/bash
# =============================================================================
# PGOT v10 — V9 BCE anchor + weak object competition CE.
#
# BCE keeps V3/V9-style object coverage. Object-level competition CE adds a weak
# patch-owner signal over {thing objects + stuff objects + register background}.
# Eval should be checked with both threshold and competition readouts.
# =============================================================================
set -euo pipefail
...
OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/PGOT/checkpoints/pgot_main_v10_bce_ce01}"
...
PGOT_MASK_CE_WEIGHT="${PGOT_MASK_CE_WEIGHT:-0.1}"
...
export WANDB_NAME="${WANDB_NAME:-pgot_main_v10_bce_ce01}"
...
echo "===== PGOT v10 BCE + weak competition CE — B200 x ${NUM_GPUS} ====="
echo "Output:          ${OUTPUT_DIR}"
echo "Effective batch: $((PER_DEVICE_TRAIN_BATCH_SIZE * NUM_GPUS * GRADIENT_ACCUMULATION_STEPS))"
echo "Mask loss:       BCE=${PGOT_MASK_BCE_WEIGHT}, CE=${PGOT_MASK_CE_WEIGHT}, ce_temp=${PGOT_MASK_CE_TEMPERATURE}"
echo "Eval:            run threshold and competition readouts"
