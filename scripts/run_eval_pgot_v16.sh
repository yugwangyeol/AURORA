#!/bin/bash
# PGOT v16 evaluation: V15 sigmoid threshold readout with extra recon-only
# void/scene capacity in the checkpoint.
set -euo pipefail
...
OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/PGOT/outputs/eval_pgot_v16_$(basename "${MODEL_PATH}")}"
...
echo "===== PGOT v16 BCE-bottleneck Eval ====="
