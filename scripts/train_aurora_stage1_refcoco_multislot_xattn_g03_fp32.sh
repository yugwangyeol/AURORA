...
OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/AURORA/checkpoints/aurora_refcoco_dual1024_slot48_pair4_reg64_xattn_cosmin_stage1_fp32}"
EXPERIMENT_NAME="${EXPERIMENT_NAME:-aurora_refcoco_dual1024_slot48_pair4_reg64_xattn_cosmin_stage1_fp32}"
...
env \
  ...
  bash "${SCRIPT_DIR}/train_aurora_stage1_refcoco_multislot_fp32.sh"
