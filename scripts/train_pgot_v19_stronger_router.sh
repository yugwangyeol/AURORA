#!/bin/bash
# =============================================================================
# PGOT v19: V15 BCE bottleneck with a deeper zero-init OVT router.
#
# Base path is V15:
#   register=0, void=1, V14 OVT/void bottleneck forward enabled,
#   route CE disabled, sigmoid BCE mask supervision enabled.
#
# New V19 change:
#   PGOTOVTBottleneckRouter depth > 1. Extra residual OVT-attention refine
#   blocks start with zero gates, so the run begins from the V15 behavior and
#   learns extra router capacity during training.
# =============================================================================
set -euo pipefail
...
OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/PGOT/checkpoints/pgot_main_v19_stronger_router}"
...
PGOT_V14_ROUTER_DEPTH="${PGOT_V14_ROUTER_DEPTH:-3}"
...
export WANDB_NAME="${WANDB_NAME:-pgot_main_v19_stronger_router}"
...
echo "===== PGOT v19 stronger router - B200 x ${NUM_GPUS} ====="
