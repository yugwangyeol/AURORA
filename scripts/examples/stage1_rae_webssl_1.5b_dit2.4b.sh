...
# Configuration: RAE-WebSSL (Qwen2.5-1.5B + 2.4B DiT)
#
...
export EXPERIMENT_NAME="stage1_rae_webssl_1.5b_dit2.4b"
...
TRAIN_ARGS="
    ...
    --vision_tower_aux_list [\"facebook/webssl-dino300m-full2b-224\"] \
...
echo "=========================================="
echo "Scale-RAE Stage 1 Training (WebSSL)"
echo "=========================================="
