#!/bin/bash
#
# Scale-RAE Stage 1: VAE Alignment Training
# Train model to generate VAE latents compatible with FLUX decoder
#
...
export EXPERIMENT_NAME="stage1_vae_alignment_1.5b_dit2.4b"
...
TRAIN_ARGS="
    ...
    --generation_alignment_tower black-forest-labs/FLUX.1-dev-res256 \
...
echo "=========================================="
echo "Scale-RAE VAE Alignment Training"
echo "=========================================="
echo "Experiment: ${EXPERIMENT_NAME}"
echo "Output: ${GCS_OUTPUT_DIR}"
echo "VAE Alignment: FLUX.1-dev-res256"
echo "=========================================="

python scale_rae/train/train_spmd.py ${TRAIN_ARGS}

echo "VAE alignment training completed!"
