#!/usr/bin/env bash
# Full autoregressive evaluation with rFID, KID, and object-count MAE.
set -euo pipefail
...
export OUTPUT_DIR="${OUTPUT_DIR:-${PROJECT_ROOT}/outputs/eval_pgot_oneshot_memory8_register32_noprior/ar}"
