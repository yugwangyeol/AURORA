#!/bin/bash
# Verifies v15.1 train, in-training eval, save, W&B sigmoid/recon overlays,
...
OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/PGOT/checkpoints/pgot_smoke_v15_1}"
EVAL_OUTPUT_DIR="${EVAL_OUTPUT_DIR:-/home/jovyan/PGOT/outputs/smoke_pgot_v15_1_eval}"
...
export WANDB_NAME="${WANDB_NAME:-pgot_smoke_v15_1}"
export WANDB_DIR="${OUTPUT_DIR}/wandb"
export PYTHONNOUSERSITE=1
export CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-0}"

echo "===== PGOT v15.1 CODA + mm_projector SMOKE ====="
...
grep -q "mm_projector" "${OUTPUT_DIR}/smoke_train.log"
...
echo "===== PGOT v15 STANDALONE THRESHOLD EVAL ====="
