#!/bin/bash
# PGOT v22a evaluation: V15/V3-style sigmoid threshold readout on 32x32 masks.
set -euo pipefail

MODEL_PATH="${MODEL_PATH:-/home/jovyan/PGOT/checkpoints/pgot_main_v22a_attention_binding}"
VAL_JSONL="${VAL_JSONL:-/home/jovyan/PGOT/data/pgot_val.jsonl}"
OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/PGOT/outputs/eval_pgot_v22a_$(basename "${MODEL_PATH}")}"
...
echo "===== PGOT v22a Attention Binding Eval ====="
