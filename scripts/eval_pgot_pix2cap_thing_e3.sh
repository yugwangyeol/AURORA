#!/usr/bin/env bash
# Teacher-forced E3 evaluation. Override VAL_JSONL for a controlled caption ablation.
set -euo pipefail
...
OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/PGOT/outputs/eval_pgot_pix2cap_thing_e3_10k_tf_coda512}"
