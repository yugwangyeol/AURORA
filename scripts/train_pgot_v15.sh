#!/bin/bash
# =============================================================================
# PGOT v15: V3 sigmoid BCE masks + V14 OVT/void bottleneck reconstruction.
#
...
OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/PGOT/checkpoints/pgot_main_v15_bce_bottleneck}"
...
export WANDB_NAME="${WANDB_NAME:-pgot_main_v15_bce_bottleneck}"
...
echo "===== PGOT v15 BCE + OVT bottleneck — B200 x ${NUM_GPUS} ====="
