#!/bin/bash
# =============================================================================
# PGOT v8.2 smoke test.
# Verifies train, in-training eval, save, offline wandb table logging, and eval.
# =============================================================================
set -euo pipefail
...
OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/PGOT/checkpoints/pgot_smoke_v8_2}"
EVAL_OUTPUT_DIR="${EVAL_OUTPUT_DIR:-/home/jovyan/PGOT/outputs/smoke_pgot_v8_2_eval}"
...
export WANDB_NAME="${WANDB_NAME:-pgot_smoke_v8_2_spatial_outside_log}"
...
echo "===== PGOT v8.2 SMOKE TEST (BS=${PER_DEVICE_TRAIN_BATCH_SIZE}, steps=${MAX_STEPS}) ====="
...
echo "===== PGOT v8.2 SMOKE EVAL (spatial/pix2cap_panoptic) ====="
