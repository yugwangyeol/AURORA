#!/bin/bash
# =============================================================================
# PGOT v13 evaluation. Train-matched main readout: threshold + mean merge.
# =============================================================================
set -euo pipefail

MODEL_PATH="${MODEL_PATH:-/home/jovyan/PGOT/checkpoints/pgot_main_v13_sigmoid_out_reg}"
VAL_JSONL="${VAL_JSONL:-/home/jovyan/PGOT/data/pgot_val.jsonl}"
READOUT="${READOUT:-threshold}"
OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/PGOT/outputs/eval_pgot_v13_${READOUT}_$(basename "${MODEL_PATH}")}"
