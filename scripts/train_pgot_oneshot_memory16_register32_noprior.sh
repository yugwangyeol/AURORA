#!/usr/bin/env bash
# Capacity experiment: 16 memories/object and 32 memories/register, without owner log-prior.
set -euo pipefail
...
export WANDB_NAME="${WANDB_NAME:-pgot_oneshot_memory16_register32_noprior}"
export MEMORY_KEY_MODE=content
export E11_MEMORIES_PER_OWNER=32
export E11_OBJECT_MEMORIES_PER_OWNER=16
