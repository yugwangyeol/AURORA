#!/usr/bin/env bash
# Autoregressive full evaluation for no-prior Memory4 + direct RAE Reader query.
set -euo pipefail
...
export OUTPUT_DIR="${OUTPUT_DIR:-${PROJECT_ROOT}/outputs/eval_pgot_oneshot_memory4_noprior_directrae/ar}"
