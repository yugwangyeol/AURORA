#!/usr/bin/env bash
# Autoregressive full evaluation for the Object-8/Register-32 direct-query adapter.
set -euo pipefail
...
export OUTPUT_DIR="${OUTPUT_DIR:-${PROJECT_ROOT}/outputs/eval_pgot_oneshot_memory8_register32_noprior_directrae_adapter/ar}"
