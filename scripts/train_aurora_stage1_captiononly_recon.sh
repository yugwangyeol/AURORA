#!/bin/bash
# =============================================================================
# Caption-only reconstruction control: request-style prompt + caption only
# =============================================================================
...
export OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/AURORA/checkpoints/captiononly_recon_stage1}"
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-captiononly_recon_stage1}"
...
export CAPTIONSLOT_CONTROL_MODE="${CAPTIONSLOT_CONTROL_MODE:-caption_only}"
...
export CAPTIONSLOT_EVAL_NUM_IMAGES="${CAPTIONSLOT_EVAL_NUM_IMAGES:-16}"
...
echo "===== Caption-Only Reconstruction Control ====="
