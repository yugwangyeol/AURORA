#!/usr/bin/env bash
# Teacher-forced E4 evaluation on the existing Pix2Cap validation manifest.
set -euo pipefail

MODEL_PATH="${MODEL_PATH:-/home/jovyan/PGOT/checkpoints/pgot_pix2cap_thing_e4/checkpoint-5000}"
VAL_JSONL="${VAL_JSONL:-/home/jovyan/PGOT/data/pgot_pix2cap_thing_val.jsonl}"
OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/PGOT/outputs/eval_pgot_pix2cap_thing_e4_5k_tf_coda512}"
