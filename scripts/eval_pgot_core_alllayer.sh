...
MODEL_PATH="${MODEL_PATH:-/home/jovyan/PGOT/checkpoints/pgot_core_alllayer}"
VAL_JSONL="${VAL_JSONL:-/home/jovyan/PGOT/data/pgot_val.jsonl}"
OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/PGOT/outputs/eval_pgot_core_alllayer_full2338}"
MAX_SAMPLES="${MAX_SAMPLES:-}"
COMPUTE_RFID="${COMPUTE_RFID:-False}"
...
if [ "${COMPUTE_RFID}" = "True" ]; then EXTRA_ARGS+=(--compute_rfid); fi
...
"${PYTHON}" -m pgot.eval.run_eval \
    ...
    --grid_size 32 --max_caption_tokens 2048 --n_ovt_per_object 1 --max_objects 50 \
