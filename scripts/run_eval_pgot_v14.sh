#!/bin/bash
# PGOT v14 evaluation using the train-matched OVT bottleneck route maps.
set -euo pipefail

MODEL_PATH="${MODEL_PATH:-/home/jovyan/PGOT/checkpoints/pgot_main_v14_ovt_bottleneck}"
VAL_JSONL="${VAL_JSONL:-/home/jovyan/PGOT/data/pgot_val.jsonl}"
OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/PGOT/outputs/eval_pgot_v14_$(basename "${MODEL_PATH}")}"
...
echo "===== PGOT v14 OVT-bottleneck Eval ====="
echo "Ckpt:     ${MODEL_PATH}"
echo "Out:      ${OUTPUT_DIR}"
echo "GT:       ${GT_SOURCE}"
echo "Image:    ${IMAGE_PREPROCESS_MODE}"
echo "Readout:  ovt_owner route"
echo "Void:     residual/background route"
