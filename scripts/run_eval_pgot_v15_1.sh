#!/bin/bash
# PGOT v15.1 evaluation: V3-style sigmoid threshold readout on 32x32 masks.
set -euo pipefail
...
OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/PGOT/outputs/eval_pgot_v15_1_$(basename "${MODEL_PATH}")}"
...
echo "===== PGOT v15.1 CODA + mm_projector Eval ====="
