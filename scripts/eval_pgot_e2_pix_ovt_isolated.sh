#!/usr/bin/env bash
# Teacher-forced CODA-protocol evaluation for E2-Pix-OVT-Isolated.
set -euo pipefail
...
OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/PGOT/outputs/eval_pgot_e2_pix_ovt_isolated_10k_tf_coda512}"
