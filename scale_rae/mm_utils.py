...
def process_images(images, image_processor, model_cfg):
    ...
    if model_cfg.image_aspect_ratio == 'pad':
        ...
        for processor_aux in processor_aux_list:
            ...
            # FIXME@shusheng: bugs here
            new_images_aux_list.append(image_aux.unsqueeze(0))
    elif model_cfg.image_aspect_ratio == 'square':
        image_aux_list = []
        for image in images:
        ...
        raise NotImplementedError("Only pad and square are supported for now.")
